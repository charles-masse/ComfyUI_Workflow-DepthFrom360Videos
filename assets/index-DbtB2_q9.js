...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function to(e,t,n){let r=new Float32Array(Va),i=new q(0,1,0);return new Oi({name:`SphericalGaussianBlur`,defines:{n:Va,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:io(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function no(){return new Oi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:io(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ro(){return new Oi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:io(),fragmentShader:`
	...
	`}var ao=class extends Gt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new pi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
}`,hl=`vec3 getDepth(sampler2D depth, vec2 uvs) {
...
/** Use compiler definitions to know which method to pick */
    ...
    **/
    ...
    gl_Position = projectionMatrix *
                    modelViewMatrix *
                    vec4(offset, 1.0);
}`,gl={colorTexture:{type:`t`,value:null},depthTexture:{type:`t`,value:null},time:{type:`f`,value:0},opacity:{type:`f`,value:1},pointSize:{type:`f`,value:3},debugDepth:{type:`f`,value:0},displacement:{type:`f`,value:1}},_l=function(e){return e[e.LOW=64]=`LOW`,e[e.MEDIUM=128]=`MEDIUM`,e[e.HIGH=256]=`HIGH`,e[e.EXTRA_HIGH=512]=`EXTRA_HIGH`,e[e.EPIC=1024]=`EPIC`,e}(_l||{}),vl=function(e){return e[e.WIRE=0]=`WIRE`,e[e.POINTS=1]=`POINTS`,e[e.MESH=2]=`MESH`,e}(vl||{}),yl=function(e){return e[e.TOP_BOTTOM=0]=`TOP_BOTTOM`,e[e.SEPERATE=1]=`SEPERATE`,e}(yl||{}),bl=class{type=yl.SEPERATE;density=_l.HIGH;style=vl.MESH;displacement=4;radius=6},xl=class e extends Sn{props=new bl;static geometry;material=new Oi({uniforms:gl,vertexShader:hl,fragmentShader:ml,transparent:!0,side:1});constructor(t,n,r){super(),this.setProps(this.props,r),this.setShaderDefines(this.material,[yl[this.props.type]]),e.geometry||=this.createSphereGeometry(this.props.radius,this.props.density),this.assignTexture(this.props.type,t,n),this.displacement=this.props.displacement,super.add(this.createMesh(e.geometry,this.material,this.props.style))}setShaderDefines(e,t){t.forEach(t=>e.defines[t]=``)}createSphereGeometry(e,t){return new yi(e,t,t)}setProps(e,t){if(t)for(let n in t)e[n]?e[n]=t[n]:console.warn(`THREE.SixDOF: Provided ${n} in config but it is not a valid property and being ignored`)}assignTexture(e,t,n){if(e===yl.SEPERATE){if(!n)throw Error(`When using seperate texture type, depthmap must be provided`);this.depth=this.setDefaultTextureProps(n)}this.texture=this.setDefaultTextureProps(t)}setDefaultTextureProps(e){return e.minFilter=a,e.magFilter=c,e.generateMipmaps=!1,e}createMesh(e,t,n){switch(n){case vl.WIRE:return this.material.wireframe||(this.material.wireframe=!0),new Jr(e,t);case vl.MESH:return this.material.wireframe&&(this.material.wireframe=!1),new Jr(e,t);case vl.POINTS:return new di(e,t)}}toggleDepthDebug(e){this.material.uniforms.debugDepth.value=e??!this.material.uniforms.debugDepth.value}set displacement(e){this.material.uniforms.displacement.value=e}set depth(e){this.material.uniforms.depthTexture.value=e}set texture(e){this.material.uniforms.colorTexture.value=e}set opacity(e){this.material.uniforms.opacity.value=e}set pointSize(e){this.material.uniforms.pointSize.value=e}get config(){return this.props}get opacity(){return this.material.uniforms.opacity.value}get pointSize(){return this.material.uniforms.pointSize.value}get displacement(){return this.material.uniforms.displacement.value}get texture(){return this.material.uniforms.colorTexture.value}get depth(){return this.material.uniforms.opacity.value}},Sl=new Wc({canvas:document.querySelector(`#canvas`)});Sl.setSize(window.innerWidth,window.innerHeight),Sl.xr.enabled=!0,document.body.appendChild(pl.createButton(Sl));var Cl=new jn,wl=new oa(75,window.innerWidth/window.innerHeight,.01,1e3),Tl=new el(wl,Sl.domElement);wl.position.set(0,5,25),Tl.autoRotate=!0;var El=new Qi,Dl=El.load(`color.png`);Dl.format=E;var Ol=new xl(Dl,El.load(`depth.png`),{radius:7,density:1024,style:vl.POINTS});Cl.add(Ol),Sl.setAnimationLoop(kl);function kl(e){Tl.update(),Sl.render(Cl,wl)}window.addEventListener(`resize`,e=>{wl.aspect=window.innerWidth/window.innerHeight,wl.updateProjectionMatrix(),Sl.setSize(window.innerWidth,window.innerHeight)});